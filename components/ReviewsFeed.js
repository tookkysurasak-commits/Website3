      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="px-3 py-2 rounded-xl bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
          >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-4 gap-1.5 bg-slate-50 p-2 rounded-xl text-[10px] text-center font-medium text-slate-600 border border-slate-100">
                  <div>รสชาติ <b className="text-orange-600 block">{rev.taste_score}★</b></div>
                  ...
                  <div>ความคุ้มค่า <b className="text-purple-600 block">{rev.value_score}★</b></div>
                </div>
              </div>

              {/* Comment Content */}
              {rev.comment && (
                <p className="text-xs sm:text-sm text-slate-700 leading-relaxed bg-orange-50/30 p-3 rounded-2xl border border-orange-100/50">
                  "{rev.comment}"
                </p>
              )}
