...
export const DAYS_OF_WEEK = [
  { id: 'all', name: 'ทุกวัน (จันทร์ - เสาร์)', short: 'ทั้งหมด', dayNum: 0, color: 'bg-slate-900 text-white' },
  { id: '1', name: 'วันจันทร์', short: 'จันทร์', dayNum: 1, color: 'bg-yellow-500 text-white', badge: 'bg-yellow-100 text-yellow-800 border-yellow-300' },
  { id: '2', name: 'วันอังคาร', short: 'อังคาร', dayNum: 2, color: 'bg-pink-500 text-white', badge: 'bg-pink-100 text-pink-800 border-pink-300' },
  { id: '3', name: 'วันพุธ', short: 'พุธ', dayNum: 3, color: 'bg-emerald-500 text-white', badge: 'bg-emerald-100 text-emerald-800 border-emerald-300' },
  { id: '4', name: 'วันพฤหัสบดี', short: 'พฤหัสบดี', dayNum: 4, color: 'bg-orange-500 text-white', badge: 'bg-orange-100 text-orange-800 border-orange-300' },
  { id: '5', name: 'วันศุกร์', short: 'ศุกร์', dayNum: 5, color: 'bg-sky-500 text-white', badge: 'bg-sky-100 text-sky-800 border-sky-300' },
  { id: '6', name: 'วันเสาร์', short: 'เสาร์', dayNum: 6, color: 'bg-purple-500 text-white', badge: 'bg-purple-100 text-purple-800 border-purple-300' },
];

export const getMenuDayInfo = (dateStr) => {
  if (!dateStr) return { dayNum: 1, name: 'วันจันทร์', short: 'จันทร์', badge: 'bg-yellow-100 text-yellow-800 border-yellow-300' };
  const d = new Date(dateStr);
  if (isNaN(d.getTime())) return { dayNum: 1, name: 'วันจันทร์', short: 'จันทร์', badge: 'bg-yellow-100 text-yellow-800 border-yellow-300' };
